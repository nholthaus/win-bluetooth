...
std::unordered_map<Protocol, QUuid> BluetoothUuid::m_protocolUuids
{
	...
	{ Protocol::OBEX, QUuid((int)Protocol::OBEX << 16, 0x0000, 0x1000, 0x80, 0x00, 0x00, 0x80, 0x5F, 0x9B, 0x34, 0xFB) },
};
 ...
 std::unordered_map<ServiceClass, QUuid> BluetoothUuid::m_serviceClassUuids
 {
	...
	{ ServiceClass::OPP,		QUuid((int)ServiceClass::OPP /*<< 16*/, 0x0000, 0x1000, 0x80, 0x00, 0x00, 0x80, 0x5F, 0x9B, 0x34, 0xFB) },
	{ ServiceClass::FTP,		QUuid((int)ServiceClass::FTP /*<< 16*/, 0x0000, 0x1000, 0x80, 0x00, 0x00, 0x80, 0x5F, 0x9B, 0x34, 0xFB) },
	{ ServiceClass::SerialPort,	QUuid((int)ServiceClass::SerialPort /*<< 16*/, 0x0000, 0x1000, 0x80, 0x00, 0x00, 0x80, 0x5F, 0x9B, 0x34, 0xFB) },
